...
population.2014 <- as.tibble(read.xlsx('PopulationReport.xlsx', sheetName = 'Pop2014', startRow = 8, header = FALSE))
...
gp.numbers <- read.csv('table_2018-03-12_14-41-09.csv', skip = 11)
